...
FK_Transactions_CashOnDelivery	FOREIGN KEY	Transactions.CODID	 ---> [FK] 	CashOnDelivery.CODID
FK_Transactions_Seller	FOREIGN KEY	Transactions.SellerMerchantID	 ---> [FK] 	Merchants.MerchantID
